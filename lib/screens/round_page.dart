              ...
              children: [
                ...
                Container(
                    ...
                    child: _getTextField(context, _textcontroller1,
                        variable_name, "Введите координату Xa:")),
                Container(
                    margin: const EdgeInsets.fromLTRB(20, 10, 20, 10),
                    child: _getTextField(context, _textcontroller2,
                        variable_name, "Введите координату Ya:")),
                Container(
                    margin: const EdgeInsets.fromLTRB(20, 10, 20, 10),
                    child: _getTextField(context, _textcontroller3,
                        variable_name, "Введите координату Xb:")),
                Container(
                    margin: const EdgeInsets.fromLTRB(20, 10, 20, 10),
                    child: TextField(
                      ...
                      onSubmitted: (value) {
                        try {
                          ...
                          setState(() {
                            ...
                            res = GeoMath.toReverseGeo(Xa, Ya, Xb, Yb).toString();
                          });
                        } catch (e) {
                      ...
                      decoration: const InputDecoration(
                          labelText: "Введите координату Yb:",
                      ...
                      onPressed: () {
                        try {
                          setState(() {
                            ...
                            double Xb = _getData(context, _textcontroller3);
                            double Yb = _getData(context, _textcontroller4);
                            res = GeoMath.toReverseGeo(Xa, Ya, Xb, Yb);
                          });
                        } catch (e) {
                          print("Возникла ошибка $e");
                        }
